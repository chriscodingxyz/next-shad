    ...
    <div className='min-h-main flex-center-col space-y-6 font-jetbrains-mono'>
      ...
      <div className='flex flex-col items-center space-y-4'>
        ...
        <div className='flex items-center gap-3'>
          {/* Next.js Badge */}
          <div className='flex items-center gap-1.5 bg-muted/50 border rounded-full px-2.5 py-1.5'>
            <svg width="16" height="16" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-foreground">
              <circle cx="90" cy="90" r="87" fill="currentColor" stroke="none"/>
              <path d="M149.508 157.52L69.142 54H54V125.97H66.1136V69.3836L139.999 164.845C143.333 162.614 146.509 160.165 149.508 157.52Z" fill="url(#paint0_linear_next)" className="fill-background"/>
              <rect x="115" y="54" width="12" height="72" fill="url(#paint1_linear_next)" className="fill-background"/>
              <defs>
                <linearGradient id="paint0_linear_next" x1="109" y1="116.5" x2="144.5" y2="160.5" gradientUnits="userSpaceOnUse">
                  ...
                  <stop offset="1" className="[stop-color:theme(colors.background)]" stopOpacity="0"/>
                </linearGradient>
          ...
          {/* Tailwind CSS Badge */}
          <div className='flex items-center gap-1.5 bg-muted/50 border rounded-full px-2.5 py-1.5'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33" width="16" height="10">
              <g clipPath="url(#a)">
